        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="space-y-5 md:space-y-6">
              ...
              >
               "As a doctor, I see how challenging chronic kidney disease can be. This study is a way for us to explore potential options that may help slow kidney damage and improve quality of life. Every person who joins helps us move one step closer to better care in the future."
              </motion.blockquote>
            </div>
          </div>
        </div>
