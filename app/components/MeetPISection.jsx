        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="space-y-5 md:space-y-6">
              ...
              >
               "As a doctor, I see how challenging severe asthma can be for patients and their families. The IMAGINE Study represents hope for a breakthrough treatment that could provide better control with fewer injections. Every participant helps us advance toward more effective asthma management and improved quality of life."
              </motion.blockquote>
            </div>
          </div>
        </div>
